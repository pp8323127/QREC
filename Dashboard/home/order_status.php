							...
							<div class="col-xs-12">
								...
								<div class="widget-box">
									<div class="widget-header widget-header-blue widget-header-flat">
										<h4 class="widget-title lighter">訂單編號 :  <b><?=$order[2];?></b></h4>
									</div>
															...
															<table id="simple-table" class="table table-striped table-bordered table-hover">
																<thead>
																	<tr>
																		...
																		<th class="center">單價</th>
																	</tr>
																</thead>
																<tbody>
																<?php
		foreach(json_decode($order[3]) as $json => $key){
			$sql="select name, price from product where pid='{$key->pid}'";
			$item_row = fetchQueryAll($sql);
